...
Let's make a checklist of what we want from an experimental method to study gene expression and its regulation:

1. It should be high throughput. That means it should tell us about the expression of (almost) every single gene in a single experiment.
2. 
