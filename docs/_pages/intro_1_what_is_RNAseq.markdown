...
![DNA](../assets/DNA.jpg)
**Figure 1:** *The chemical structure of DNA. DNA comes in four different varieities distinguished by the composition of their nitrogenous bases. These four varieties are typically denoted by the a single letter: A, G, C, and T. [Figure source](https://chem.libretexts.org/Courses/Metropolitan_State_University_of_Denver/MSU_Denver%3A_Biochemistry_II/1%3A_Biochemistry_I_Nucleic_Acid_Review/1.1%3A_Nitrogenous_bases%2C_Nucleosides_and_Nucleotides)*
